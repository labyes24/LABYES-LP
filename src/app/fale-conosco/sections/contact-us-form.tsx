    ...
    return (
        <section className="relative min-h-[460px] overflow-x-clip px-6 pb-20 pt-14 xl:pt-20 min-[1475px]:overflow-x-visible">
            ...
            <Image
                src={icons.CoolEmoji}
                alt="Cool Emoji"
                className="delay-250 absolute bottom-[18px] right-[8px] -z-10 h-auto w-auto duration-1000 animate-in fade-in sm:bottom-[24px] sm:right-[15px] sm:scale-[125%] xl:bottom-[110px] xl:right-[110px] xl:scale-[166%]"
                role="presentation"
            />
