...
export function Header() {
    return (
        <header className="border-section-medium sticky left-0 right-0 top-0 z-50 flex h-fit items-center justify-between gap-6 border-b bg-background p-6 md:px-36 md:py-8">
            <Link
                href={'/'}
